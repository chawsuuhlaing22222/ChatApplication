...
class CreateMomentActivity : AppCompatActivity(),MomentView {
     ...
     private fun setUpActionListener() {
        btnAddImage.setOnClickListener {
         ...
         btnCreate.setOnClickListener {
             ...
             var moment=MomentVO("${UUID.randomUUID()}",mUserVO.name,
    ...
    private fun showChooseAlert(){
       // var  dialog= AlertDialog.Builder
        ...
        var view= LayoutInflater.from(this).inflate(R.layout.view_holder_choose_image_from_dialog,null)
        ...
        view.btnCanmera.setOnClickListener {
                ...
                if(hasPermission()){
                   ...
                   // Create camera intent
                    ...
                    //startActivityForResult(takePictureIntent, REQUEST_PICK_IMAGE_FROM_CAMERA)
                    dialog.dismiss()
                }else{
                    requestPermission()
                }
